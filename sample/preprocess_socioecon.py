...
indigenous_social_df = pd.read_csv(mount_path + "/SA data/NATSEM_-_Social_and_Economic_Indicators_-_Indigenous_Indicators_SA2_2016.csv/data6735501229514139095.csv")
...
#region 5. merge all socio-economic variables
...
# save files
socio_econ_df.to_pickle('./data/socio_econ_df.pickle')
